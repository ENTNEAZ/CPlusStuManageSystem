...
class Stu {
public:
	Stu(int id, string name, string sex, string field, string year, int month, int day, char address[], float E_grade);
	~Stu();
	...
	static void addRaw(int id, string name, string sex, string field, string year, int month, int day, char address[], float E_grade);
